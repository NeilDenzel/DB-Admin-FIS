...
return new class extends Migration
{
    ...
    {
        DB::statement('SET FOREIGN_KEY_CHECKS = 0');
        DB::statement('ALTER TABLE estudiante MODIFY cod_estudiante CHAR(10) NOT NULL');
        DB::statement('ALTER TABLE situacion_academica MODIFY cod_estudiante CHAR(10) NOT NULL');
        DB::statement('ALTER TABLE matricula MODIFY cod_estudiante CHAR(10) NOT NULL');
        DB::statement('SET FOREIGN_KEY_CHECKS = 1');
    }
};
